...
private:
	...
	CvCascadeImageReader daniel_negReader;  // DANIEL_BUG_FIX: Added Another Reader in order to be able to read negative examples from vec file and not .dat file
